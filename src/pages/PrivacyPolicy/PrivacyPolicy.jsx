...
import { FaShieldAlt, FaUserLock, FaCookieBite, FaQuestionCircle } from "react-icons/fa";
  ...
  return (
    <div className="max-w-10/12 mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-8 text-gray-300">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-black">Last Updated: {new Date().toLocaleDateString()}</p>
      </div>
      ...
      <div className="bg-[#0B213A] rounded-xl shadow-xl p-8 sm:p-10 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p>
            At CodeStack, we take your privacy seriously. This Privacy Policy explains how we collect, 
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Personal Data:</strong> Name, email address, profile picture when you register
            </li>
            <li>
        ...
        {/* Data Sharing */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-white">3. Data Sharing & Disclosure</h2>
          <p>
        ...
        {/* Changes */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-white">7. Policy Changes</h2>
          <p>
        ...
        <div className="pt-8 text-center text-sm text-gray-400">
          <p>
            By using CodeStack, you acknowledge you have read and understood this Privacy Policy.
          </p>
        </div>
      </div>
    </div>
